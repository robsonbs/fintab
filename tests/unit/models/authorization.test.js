...
describe("models/authorization.js", () => {
  describe(".canPerformAction()", () => {
    ...
    test("without `user.features`", () => {
      ...
      expect(() => {
        authorization.canPerformAction(createdUser);
      }).toThrow(InternalServerError);
    });
    ...
    test("with unknown `feature`", () => {
      ...
      expect(() => {
        authorization.canPerformAction(createdUser, "unknown:feature");
      }).toThrow(InternalServerError);
    });
    ...
    test("with valid `user` and known `feature`", () => {
      ...
      expect(authorization.canPerformAction(createdUser, "create:user")).toBe(
        true,
      );
    });
  });
